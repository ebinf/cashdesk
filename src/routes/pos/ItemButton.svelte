...
<button
	on:click
	type="button"
	class="relative min-h-20 aspect-1 rounded-md bg-{color}-600 px-3.5 py-2.5 text-white shadow-sm overflow-hidden focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600"
>
	...
	{#if amount > 0}
		<p class="opacity-20 text-9xl font-bold absolute -left-1 -bottom-7 leading-none">
			{amount}
		</p>
	{/if}
</button>
